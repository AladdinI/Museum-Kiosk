...
let postUrl = 'https://waps.cfa.harvard.edu/microobservatory/own_kiosk/api/v1/emails/email_image_dev.php';
////////////////////////////////////
createFormData = () => {
    ...
    let activity_path = document.getElementById('activity_path');
    ...
    let data = 
        {
            ...
            activity_path: activity_path.value,
